...
<template>
    <section class="my-10">
        <div class="whitespace-nowrap">
            ...
            <h1 class="text-4xl md:text-5xl font-bold">Colaboradores</h1>
        </div>
        <p class="mt-2 text-lg">Veja quem são os membros da nossa equipe, que fazem tudo isso ser possível.</p>
